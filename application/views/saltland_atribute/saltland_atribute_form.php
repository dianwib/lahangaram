	...
	<section class="content">
		<div class="box box-primary box-solid">
			<div class="box-header with-border">
				<h3 class="box-title">INPUT DATA SALTLAND ATRIBUTE</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<tr>
					<td width='200'>Value <?php echo form_error('value1') ?></td>
				...
				<tr>
					...
					<tr>
						<td><input type="hidden" name="id1" value="<?php echo $id1; ?>" /> 
							...
							<a href="<?php echo site_url('saltland_atribute') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
				</table>
			</form>
