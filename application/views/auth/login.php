...
<body>
    ...
    <div class="container login-container">
        <div class="row">
            <div class="col-md-6 login-form-1" style="background-color: white">
                <div id="map">
                </div>
            </div>
            <div class="col-md-6 login-form-2">
                ...
                <div class="form-group">
                    ...
                    <small class="text-center text-dark">*<?php echo $message; ?></small>
                ...
                <div class="form-group">
                    <?php echo anchor('auth/register', 'Registrasi Akun', array('class' => 'ForgetPwd text-dark')); ?> |
                    <?php echo anchor('#', '<a href="#" class="ForgetPwd text-dark" value="Login">Forget Password?</a>'); ?>
                </div>
            </form>
        </div>
    </div>
...
.login-form-2{
    padding: 5%;
        background-image: url("<?php echo base_url(); ?>assets/26PTGaram-1472192350.jpg");
