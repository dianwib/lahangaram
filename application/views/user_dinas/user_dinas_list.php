            ...
            <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA USER_DINAS</h3>
                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "user_dinas/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id1",
                            "orderable": false
                        },{"data": "NIK"},{"data": "name"},{"data": "adress"},{"data": "phone"},{"data": "email"},{"data": "create_date"},{"data": "aprove"},{"data": "id_regencies"},
                        {
                            "data" : "action",
                            "orderable": false,
